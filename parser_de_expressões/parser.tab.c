...
{
  "$end", "error", "$undefined", "NUM", "ADD", "MUL", "DIV", "SUB",
  "OPBAR", "CLOBAR", "NEWLIN", "$accept", "calc", "exp", "termo", "fator", YY_NULLPTR
};
#endif
...
{
      -8,     3,    -8,    -8,     5,    -3,    -8,    13,     8,    -7,
       5,     5,    -8,     5,     5,    -8,    -8,    13,    13,    -8,
      -8
};
...
{
       2,     0,     1,     7,     0,     0,    10,     4,     0,    10,
       0,     0,     3,     0,     0,     9,     8,     5,     6,    11,
      12
};
...
{
       9,    10,    16,     2,    11,     8,     3,    12,     3,    19,
      20,     4,    10,     4,     0,    11,     0,    15,    13,    14,
      17,    18
};

static const yytype_int8 yycheck[] =
{
       4,     4,     9,     0,     7,     4,     3,    10,     3,    13,
      14,     8,     4,     8,    -1,     7,    -1,     9,     5,     6,
      10,    11
};
...
{
       0,    12,     0,     3,     8,    13,    14,    15,    13,    14,
       4,     7,    10,     5,     6,     9,     9,    15,    15,    14,
      14
};
